...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, schedule=modal.Cron("17 3 * * *"), timeout=600, memory=512, scaledown_window=10)
...
@app.function(image=kali_image, schedule=modal.Cron("0 * * * *"), timeout=600, memory=512, scaledown_window=10)
