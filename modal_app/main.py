...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=180, memory=512, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=120, memory=512, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=180, memory=1024, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=300, memory=1024, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=300, memory=512, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=420, memory=1024, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=360, memory=1024, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=240, memory=1024, scaledown_window=2)
...
# ---------------------------------------------------------------------------
@app.function(image=kali_image, timeout=240, memory=512, scaledown_window=2)
